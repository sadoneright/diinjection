...
public class DependencyInjecter {
	...
	public void injectDependencies(Object application) throws InstantiationException, IllegalAccessException,
		...
		for (Field field : fields) {
			if (field.isAnnotationPresent(DIInjection.class)) {
				...
				Method method = application.getClass().getMethod("set" + field.getName().substring(0, 1).toUpperCase()
